        ...
        gates: {
            1: {
                ...
                patterns: {
                  ...
                  phase300:{
                    ...
                    { name: '8. 格擋', desc: '\u2022 卡傑面對其中一名玩家暴露黃光(格擋)戳並傳送在那名玩家頭前扇形擊飛, 沒格擋成功會出現激光。',tips: '', videoId: '8UmdeuHWq-M'}
            ...
            2: {
                ...
                mechanics: [
                  ...
                  { hp: '2-1 x750前', title: '癱瘓', desc: '卡傑回到中間需求癱瘓。第一次破掉的話，出的秒殺紅圈不會很大出去外面躲避就好。如果沒破掉，第二次癱瘓后絕對要趕快跑最外面躲避。最後卡傑會破壞上半邊的場地。', type: 'stagger',videoId: 'BAr2CnAFJ2g' },
                  { hp: '2-1 x750', title: '躲避石頭+癱瘓', desc: '卡傑召喚一堆石頭撞過來並需求癱瘓, 邊躲邊打癱瘓就好。結束癱瘓后，1隊站6點二隊站3或9點開桑迪NPC打掉dps檢測, 打完就躲避正面的石頭兩次。', type: 'stagger',videoId: 'BAr2CnAFJ2g' },
                  { hp: '2-1 x600', title: '癱瘓+接劍', desc: '卡傑回到中間然後上去召喚一些石頭撞側邊進動畫， 動畫后輔助開覺醒 其他人自己躲好紅綫, 卡傑跳下來會去左或右邊記得去靠近卡傑躲避籃圈。接著卡傑會跑去中間需求癱瘓，大家必須集合站同一個位置打癱瘓，成功后要有人接劍。接劍后， 卡傑根據前面左or右邊再次回到那個位置瞄準標記玩家，標記玩家只需要引導卡傑到12點破壞掉上面的石頭。此機制要第一次破掉的話，出的秒殺紅圈不會很大出去外面躲避就好。如果沒破掉，第二次癱瘓后絕對要趕快跑最外面躲避。', type: 'stagger',videoId: 'BAr2CnAFJ2g' },
                  { hp: '2-1 x300', title: '沙漠', desc: '卡傑換成沙漠場地並出現一堆圈要躲避，最後的時候有機會站頭前能被抓去接劍增加輸出機會。接著卡傑會飛天下來中間(秒殺圈)進入動畫，x3x3+1 視角拉近就要注意按G格擋。成功格擋后ping給所有人知道你那邊好了，等到卡傑要下來的時候直接空白走然後再協同反制。', type: 'mech',videoId: 'BAr2CnAFJ2g' },
                  { hp: '2-1 x300后', title: '三角輸出機制', desc: '卡傑要求輸出要打掉3個地板紅角的輸出檢測 沒過就滅', type: 'dps',videoId: 'BAr2CnAFJ2g' }
                ]
            }
        }
    },
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                ${m.videoId ? `<div class="relative w-full aspect-video sm:w-[520px] lg:w-[640px] sm:h-[292px] lg:h-[360px] cursor-pointer group bg-black/40 overflow-hidden rounded-lg" data-video="${m.videoId}">
                                    <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                        ...
                                        <span class="mt-2 video-title text-slate-300">${m.title}</span>
                                    </div>
                                </div>` : ''}
                            </div>
                        </div>
