        ...
        gates: {
            1: {
                ...
                patterns: [
                    ...
                    { name: '分身 (Clone)', desc: '\u2022 卡傑旁邊出現一堆分身劈隨機方向，然後卡傑會隨機劈兩次 然後往自己周圍划一圈。', tips: '\u2022 看好安全位置躲好 最後靠近卡傑的要記得躲避或者霸體。', gif: 'purple_wave.gif', videoId: '3JtGtVrRlT0' },
                    { name: '落雷抓人 (Lightning Grab)', desc: '\u2022 卡傑握球出現落雷, 接著卡傑要抓隨機一個人 (困難模式如果有人被抓到後續還會有個十字攻擊) 。', tips: '\u2022 只要看到卡傑開落雷就不要站頭。<br>\u2022 如果沒人被抓背後安全, 有人被抓的話最後就站背部側邊', gif: 'purple_wave.gif', videoId: '635nAAElFSc' },
