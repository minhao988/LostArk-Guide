        ...
        gates: {
            1: {
                ...
                patterns: [
                    ...
                    { name: '落雷抓人 (Lightning Grab)', desc: '\u2022 卡傑握球出現落雷, 接著卡傑要抓隨機一個人 (困難模式如果有人被抓到後續還會有個十字攻擊) 。', tips: '\u2022 只要看到卡傑開落雷就不要站頭。<b>\u2022 如果沒人被抓背後安全, 有人被抓的話最後就站背部側邊', gif: 'purple_wave.gif', videoId: '635nAAElFSc' },
